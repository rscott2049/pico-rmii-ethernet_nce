...
void __not_in_flash_func(netif_link_callback)(struct netif *netif) {
...
int __not_in_flash_func(main)() {
  ...
  // Set up system clock
  uint32_t target_clk = 300000000;  // div = 3
  //uint32_t target_clk = 250000000; // div = 2.5
  //uint32_t target_clk = 200000000; // div = 2
  //uint32_t target_clk = 150000000; // div = 1.5
  //uint32_t target_clk = 100000000; // div = 1.0
